...
*/
use nep_246::multi_token::core::MultiTokenReceiver;
use nep_246::multi_token::token::TokenId;
...
impl MultiTokenReceiver for DeFi {
    ...
    fn mt_on_transfer(
        ...
        log!("received {} types of tokens from @{} mt_on_transfer, msg = {}", token_ids.len(), sender_id.as_ref(), msg);
